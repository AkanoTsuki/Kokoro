...
public class DataManager
{
    ...
    {       
        ...
        public List<CharacteristicPrototype> Characteristic;
        public List<ItemSuitePrototype> ItemSuite;
        public List<ConsumablePrototype> Consumable;
        public List<HaloPrototype> Halo;
    }
    ...
    public static Dictionary<int, CharacteristicPrototype> mCharacteristicDict = new Dictionary<int, CharacteristicPrototype>();
    public static Dictionary<int, ItemSuitePrototype> mItemSuiteDict = new Dictionary<int, ItemSuitePrototype>();
    public static Dictionary<int, ConsumablePrototype> mConsumableDict = new Dictionary<int, ConsumablePrototype>();
    public static Dictionary<int, HaloPrototype> mHaloDict = new Dictionary<int, HaloPrototype>();
    ...
    //随机NPC资源列表
    public static string[] mNpcName = { "npc_other1_01", "npc_other1_02", "npc_other1_03", "npc_other1_04", "npc_other1_05", "npc_other1_06", "npc_other1_07", "npc_other1_08", "npc_other1_09", "npc_other1_10",
                                        "npc_other1_11", "npc_other1_12", "npc_other1_13", "npc_other1_14", "npc_other1_15", "npc_other1_16", "npc_other1_17", "npc_other1_18", "npc_other1_19", "npc_other1_20",
                                        "npc_other1_21", "npc_other1_22", "npc_other1_23", "npc_other1_24", "npc_other1_25", "npc_other1_26", "npc_other1_27", "npc_other1_28", "npc_other1_29", "npc_other1_30",
                                        "npc_other1_31", "npc_other1_32",
                                        "npc_other2_01", "npc_other2_02", "npc_other2_03", "npc_other2_04", "npc_other2_05", "npc_other2_06", "npc_other2_07", "npc_other2_08", "npc_other2_09", "npc_other2_10",
                                        "npc_other2_11", "npc_other2_12", "npc_other2_13", "npc_other2_14", "npc_other2_15", "npc_other2_16", "npc_other2_17", "npc_other2_18",
                                        "npc_other2_21", "npc_other2_22", "npc_other2_25", "npc_other2_26", "npc_other2_29", "npc_other2_30"};
    //初始化方法
    ...
    public static void Init()
    {
        ...
        if (jsonObject.Characteristic == null) { Debug.LogError("Characteristic data null"); }
        foreach (CharacteristicPrototype item in jsonObject.Characteristic) { mCharacteristicDict[item.ID] = item; }


        if (jsonObject.ItemSuite == null) { Debug.LogError("ItemSuite data null"); }
        foreach (ItemSuitePrototype item in jsonObject.ItemSuite) { mItemSuiteDict[item.ID] = item; }

        if (jsonObject.Consumable == null) { Debug.LogError("Consumable data null"); }
        foreach (ConsumablePrototype item in jsonObject.Consumable) { mConsumableDict[item.ID] = item; }

        if (jsonObject.Halo == null) { Debug.LogError("Halo data null"); }
        foreach (HaloPrototype item in jsonObject.Halo) { mHaloDict[item.ID] = item; }
...
public class GameDataConfig : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //Debug.Log(DataManager.mHaloDict[1].Name);
